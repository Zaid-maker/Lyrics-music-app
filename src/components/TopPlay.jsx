...
const TopPlay = () => {
  ...
  /* Slicing the data from the API to only show the first 5 songs. */
  ...
  /**
   * When the user clicks on a song, set the active song to the song that was clicked on, and play the
   * song.
   */
